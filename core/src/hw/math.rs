use super::{mem::IORegister, scheduler::Scheduler, HW};
...
impl Div {
    ...
    pub fn read_numer(&self, byte: usize) -> u8 {
        self.numer.read(byte)
    }
    pub fn read_denom(&self, byte: usize) -> u8 {
        self.denom.read(byte)
    }
    pub fn read_quot(&self, byte: usize) -> u8 {
        self.quot.read(byte)
    }
    pub fn read_rem(&self, byte: usize) -> u8 {
        self.rem.read(byte)
    }
...
impl Sqrt {
    ...
    pub fn read_param(&self, byte: usize) -> u8 {
        self.param.read(byte)
    }
    pub fn read_result(&self, byte: usize) -> u8 {
        HW::read_byte_from_value(&self.result, byte)
    }
